...
import com.mapleslong.android.arch.widget.update.network.ProgressResponseBody;
...
public class MPUpdateDownload {
     ...
     * 当前实例
     */
    private static MPUpdateDownload instance;
    /**
     * UI线程
     */
     ...
     * @return
     */
    public static MPUpdateDownload with() {
        instance = new MPUpdateDownload();
        return instance;
    }
     ...
     * @return
     */
    public MPUpdateDownload url(String url) {
     ...
     * @return
     */
    public MPUpdateDownload downloadPath(String filePath) {
     ...
     * @return
     */
    public MPUpdateDownload tag(Object tag) {
     ...
     * @return
     */
    public MPUpdateDownload headers(Map<String, String> headersMap) {
     ...
     * @return
     */
    public MPUpdateDownload addHeader(String headerKey, String headerValue) {
