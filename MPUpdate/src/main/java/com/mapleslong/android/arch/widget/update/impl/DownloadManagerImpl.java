...
public class DownloadManagerImpl implements IDownloadManager {
    ...
    public void downloadAPK(String title, String desc, String url, String name) {
        //创建下载任务
...
//        request.setAllowedOverRoaming(false);
        ...
        //设置下载的路径
        request.setDestinationInExternalPublicDir(getDownalodPath(), name);
        //获取DownloadManager
